...
public class Main{
    public static void main(String[] args) {
        ...
        Armor armor1 = new Armor("Thunder Belt",5,100);
        Weapon weapon1 = new Weapon("Sky Piercer", 10);
        player1.setArmor(armor1);
        player1.setWeapon(weapon1);

        Player player2 = new Player("Fina");
        Armor armor2 = new Armor("Dress",1,40);
        Weapon weapon2 = new Weapon("Golden Staff", 40);
